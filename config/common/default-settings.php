...
return [
    ...
    //branding
    ['name' => 'branding.site_name', 'value' => 'YOOTV'],
        ...
        'value' => json_encode([
            ...
            'primaryFeatures' => [
                [
                    ...
                    'subtitle' =>
                        'Attach your own custom domain or use on of the free YOOTVsubdomains.',
                ...
                [
                    ...
                    'subtitle' =>
                        'Design and build your own high-quality websites. Whatever the type of site\u2014you can do it with YOOTVwebsite builder.',
                    'image' => 'pen-tool.svg',
                ],
            ],
            'secondaryFeatures' => [
                ...
                [
                    ...
                    'description' =>
                        'Start from scratch or choose from large catalog of templates to make your own website. With the world\u2019s most innovative drag and drop website builder, you can customize or change anything. With the YOO.TV, you can create your own professional website that looks stunning.',
                ],
            ],
        ]),
    ],
